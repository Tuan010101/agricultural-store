      ...
      <div class="bg-white p-4 h-100">
        <div class=" d-flex justify-content-center flex-column align-items-center"> <a href="/index" style="color: #000000; text-decoration: none" class="main-heading">T COFFEE</a>
          ...
          <form class="p-3 d-flex justify-content-center flex-column align-items-center" style="width: 100%" action="/sign-in" method="post">
            <c:if test="${p == 1}">
              <div class="form-data alert alert-danger" role="alert" style="text-align: center">Sai tên tài khoản hoặc mật khẩu. Vui lòng kiểm tra lại!</div>
            </c:if>
            ...
            <div class="d-flex justify-content-between w-100 align-items-center">
              ...
              <a class="text-decoration-none forgot-text" href="/sign-up">Đăng ký</a>
            </div>
            <div class="signin-btn w-100 mt-2">
              <input type="submit" class="btn btn-danger btn-block" value="Đăng nhập">
            </div>
          </form>
        </div>
      </div>
